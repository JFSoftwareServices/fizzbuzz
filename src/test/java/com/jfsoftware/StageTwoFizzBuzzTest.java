...
class StageTwoFizzBuzzTest {
    ...
    void multiplesOfFiveOrContainFive(int i) {
    ...
    void multiplesOfThreeOrContainThree(int i) {
        assertThat(rule.apply(new Number(i))).isEqualTo("Fizz");
    }

    @ParameterizedTest
    @ValueSource(ints = {15, 30, 35, 45, 51, 53, 54})
    void multiplesOfThreeOrContainsThreeAndMultipleOfFiveOrContainsFive(int i) {
    ...
    void notMultiplesOfThreeOrFiveAndDoesNotContainThreeOrFive(int i) {
